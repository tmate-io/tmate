...
const struct mode_key_cmdstr mode_key_cmdstr_copy[] = {
	...
	{ MODEKEYCOPY_SCROLLBOTTOM, "scroll-bottom" },
	{ MODEKEYCOPY_SCROLLDOWN, "scroll-down" },
	{ MODEKEYCOPY_SCROLLMIDDLE, "scroll-middle" },
	{ MODEKEYCOPY_SCROLLTOP, "scroll-top" },
...
const struct mode_key_entry mode_key_vi_copy[] = {
	...
	{ '+',			    0, MODEKEYCOPY_SCROLLTOP },
	{ '-',			    0, MODEKEYCOPY_SCROLLBOTTOM },
